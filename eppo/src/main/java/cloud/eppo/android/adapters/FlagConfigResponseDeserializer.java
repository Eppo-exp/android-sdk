...
// import static cloud.eppo.android.util.AndroidJsonParser.parseUtcISODateNode;
...
//  // deserializeBanditReference(field.getValue());
...
// deserializeVariations(jsonNode.getJSONObject("variations"));
...
//      Date startAt = parseUtcISODateString(allocationNode.has("startAt") ?
// allocationNode.getString("startAt") : null);
//      Date endAt = parseUtcISODateString(allocationNode.has("endAt") ?
// allocationNode.getString("endAt") : null);
...
//  }
//
//  private Set<TargetingRule> deserializeTargetingRules(JSONArray jsonArray) {
...
//          JSONArray conditionArray = ruleNode.getJSONArray("conditions");
//          for (int j = 0; j < conditionArray.length(); ++j) {
//            try {
//              JSONObject conditionNode = conditionArray.getJSONObject(j);
...
//              }
//              EppoValue value =
// eppoValueDeserializer.deserialize(conditionNode.getJSONObject("value"));
